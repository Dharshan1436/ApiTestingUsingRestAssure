...
public class Spotify {
    String Token = "BQCznihWtN3YhNlS367CdQOYYZsM5_iAOAvY2ISjxzV38_sBFcZOgGaKzeREiTSug32qwvblzDYfA1LdD_0_jkEvH_wbVPRPZmt7MnmIIIQFXOeaBHDTl0ij8LoIMpIiBmnGSEvYKR3Rfs8L4NF8l_IoOWbNvk9bUoOm0tDBOXHkD1jrg3tDacxXPyaPRgMDecG59ky050AmIa-R_0kzdxk5awcWn2QIVKocoklE0ujASQc2RXe90qgyI-4e3DDWb9xxwRo1tQN2MepO7lXikdHBhdrqqVthv9QUFQ6fT1tugCzklO5PTw4_YVOWNs7XUXA_E8RsavikkSVnVoNU0fU";
...
//---------------------------------------------SEARCH------------------------------------------------------------------
    ...
    public void searchForItem() {
        Response response = given()
                ...
                .header("Content-Type", "application/json")
                .header("Authorization", "Bearer " + Token)
                .queryParam("q","remaster%2520track%3ADoxy%2520artist%3AMiles%2520Davis")
                .queryParam("type","artist")
...
public void createPlaylist() {
    Response response = given()
            ...
            .body("{\n" +
                    "  \"name\": \"Dharshan PL\",\n" +
                    "  \"description\": \"New playlist description for Dharshan\",\n" +
                    "  \"public\": false\n" +
                    "}")
            .when()
    ...
    response.prettyPrint();
    p_Id = response.path("id"); // Store the playlist ID
    System.out.println("Created Playlist ID: " + p_Id); // Print for verification
    ...
    public void getPlaylist() {
        Response response = given()
                ...
                .header("Content-Type", "application/json")
                .when()
                .get("https://api.spotify.com/v1/playlists/" + p_Id);
    ...
    public void updatePlaylistDetails() {
        Response response = given()
                ...
                .header("Content-Type", "application/json")
                .body("{\n" +
                        "    \"name\": \"Updated Playlist Name for dharshn\",\n" +
                        "    \"description\": \" alreay Updated playlist description\",\n" +
                        "    \"public\": false\n" +
                        "}")
                .when()
                .put("https://api.spotify.com/v1/playlists/5vxS4GU3YHwiO2bB2lSzoW");
    ...
    public void getPlaylistItems() {
        Response response = given()
                ...
                .queryParam("offset", 5)
                .when()
                .get("https://api.spotify.com/v1/playlists/" + p_Id + "/tracks");
    ...
    public void updatePlaylistItems() {
        Response response = given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .put("https://api.spotify.com/v1/playlists/5vxS4GU3YHwiO2bB2lSzoW/tracks");
    ...
    public void addItemsToPlaylist() {
        Response response = given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .post("https://api.spotify.com/v1/playlists/" + p_Id + "/tracks?position=2");

        response.prettyPrint();
        Assert.assertEquals(response.getStatusCode(), 400); // Adjusted to 200 for success
    }
    ...
    public void removeItemsFromPlaylist() {
        Response response = given()
                ...
                .body("{\n" +
                        ...
                        "}")
                .when()
                .delete("https://api.spotify.com/v1/playlists/" + p_Id + "/tracks");

        response.prettyPrint();
        Assert.assertEquals(response.getStatusCode(), 200); // Adjusted to 200 for success
    }
    ...
    public void getPlaylistCoverImage() {
        Response response = given()
                ...
                .header("Content-Type", "application/json")
                .when()
                .get("https://api.spotify.com/v1/playlists/" + p_Id + "/images");
